...
- Surface expanded from ~20 entity sets to ~300 (a compile-survivable curated subset of the full Finance domain; see `docs/spec/sanitations.md`).
...
### Added
- Initial implementation of the Microsoft Dynamics 365 Finance and Operations connector (20 hand-curated operations from a reconstructed spec).
