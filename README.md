# Ballerina Microsoft Dynamics 365 Finance Connector
...
See [`ballerina/README.md`](ballerina/README.md) for the package overview, key features, quickstart, and examples.
