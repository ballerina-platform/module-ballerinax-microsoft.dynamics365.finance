...
import ballerinax/microsoft.dynamics365.finance.journalentry.mock as mockSrv;
...
@test:Config
function testListJournalLines() returns error? {
    Client cl = check buildClient();
    JournalLinesCollection response = check cl->listJournalLines();
