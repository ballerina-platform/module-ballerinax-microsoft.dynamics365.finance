...
import ballerinax/microsoft.dynamics365.finance.hrdev.mock as mockSrv;
...
@test:Config
function testListCourseGroups() returns error? {
    Client cl = check buildClient();
    CourseGroupsCollection response = check cl->listCourseGroups();
