...
import ballerinax/microsoft.dynamics365.finance.coreorg.mock as mockSrv;
...
@test:Config
function testListCardTypes() returns error? {
    Client cl = check buildClient();
    CardTypesCollection response = check cl->listCardTypes();
