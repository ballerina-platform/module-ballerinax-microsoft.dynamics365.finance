...
# Ballerina connector module for the 'core' slice of the Microsoft Dynamics 365 Finance OData REST API.
public isolated client class Client {
    ...
    # List AddressCountryRegions
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Collection of AddressCountryRegion 
    remote isolated function listAddressCountryRegions(map<string|string[]> headers = {}, *ListAddressCountryRegionsQueries queries) returns AddressCountryRegionsCollection|error {
        string resourcePath = string `/AddressCountryRegions`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Create AddressCountryRegion
    #
    # + headers - Headers to be sent with the request 
    # + return - AddressCountryRegion created 
    remote isolated function createAddressCountryRegions(AddressCountryRegion payload, map<string|string[]> headers = {}) returns AddressCountryRegion|error {
        string resourcePath = string `/AddressCountryRegions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Get AddressCountryRegion by key
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - AddressCountryRegion record 
    remote isolated function getAddressCountryRegions(string countryRegion, map<string|string[]> headers = {}, *GetAddressCountryRegionsQueries queries) returns AddressCountryRegion|error {
        string resourcePath = string `/AddressCountryRegions(CountryRegion='${getEncodedUri(countryRegion)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Delete AddressCountryRegion
    #
    # + headers - Headers to be sent with the request 
    # + return - AddressCountryRegion deleted 
    remote isolated function deleteAddressCountryRegions(string countryRegion, DeleteAddressCountryRegionsHeaders headers = {}) returns error? {
        string resourcePath = string `/AddressCountryRegions(CountryRegion='${getEncodedUri(countryRegion)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    }

    # Update AddressCountryRegion
    #
    # + headers - Headers to be sent with the request 
    # + return - AddressCountryRegion updated 
    remote isolated function updateAddressCountryRegions(string countryRegion, AddressCountryRegion payload, UpdateAddressCountryRegionsHeaders headers = {}) returns AddressCountryRegion|error {
        string resourcePath = string `/AddressCountryRegions(CountryRegion='${getEncodedUri(countryRegion)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Collection of AddressStreet 
    remote isolated function listAddressStreets(map<string|string[]> headers = {}, *ListAddressStreetsQueries queries) returns AddressStreetsCollection|error {
        string resourcePath = string `/AddressStreets`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    #
    # + headers - Headers to be sent with the request 
    # + return - AddressStreet created 
    remote isolated function createAddressStreets(AddressStreet payload, map<string|string[]> headers = {}) returns AddressStreet|error {
        string resourcePath = string `/AddressStreets`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Get AddressStreet by key
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - AddressStreet record 
    remote isolated function getAddressStreets(string countryRegion, string state, string county, string city_FK_Name, string district_FK_Name, string name, string description, map<string|string[]> headers = {}, *GetAddressStreetsQueries queries) returns AddressStreet|error {
        string resourcePath = string `/AddressStreets(CountryRegion='${getEncodedUri(countryRegion)}',State='${getEncodedUri(state)}',County='${getEncodedUri(county)}',City_FK_Name='${getEncodedUri(city_FK_Name)}',District_FK_Name='${getEncodedUri(district_FK_Name)}',Name='${getEncodedUri(name)}',Description='${getEncodedUri(description)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Delete AddressStreet
    #
    # + headers - Headers to be sent with the request 
    # + return - AddressStreet deleted 
    remote isolated function deleteAddressStreets(string countryRegion, string state, string county, string city_FK_Name, string district_FK_Name, string name, string description, DeleteAddressStreetsHeaders headers = {}) returns error? {
        string resourcePath = string `/AddressStreets(CountryRegion='${getEncodedUri(countryRegion)}',State='${getEncodedUri(state)}',County='${getEncodedUri(county)}',City_FK_Name='${getEncodedUri(city_FK_Name)}',District_FK_Name='${getEncodedUri(district_FK_Name)}',Name='${getEncodedUri(name)}',Description='${getEncodedUri(description)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    }
    ...
    #
    # + headers - Headers to be sent with the request 
    # + return - AddressStreet updated 
    remote isolated function updateAddressStreets(string countryRegion, string state, string county, string city_FK_Name, string district_FK_Name, string name, string description, AddressStreet payload, UpdateAddressStreetsHeaders headers = {}) returns AddressStreet|error {
        string resourcePath = string `/AddressStreets(CountryRegion='${getEncodedUri(countryRegion)}',State='${getEncodedUri(state)}',County='${getEncodedUri(county)}',City_FK_Name='${getEncodedUri(city_FK_Name)}',District_FK_Name='${getEncodedUri(district_FK_Name)}',Name='${getEncodedUri(name)}',Description='${getEncodedUri(description)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Collection of IntrastatPort 
    remote isolated function listIntrastatPorts(map<string|string[]> headers = {}, *ListIntrastatPortsQueries queries) returns IntrastatPortsCollection|error {
        string resourcePath = string `/IntrastatPorts`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Create IntrastatPort
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatPort created 
    remote isolated function createIntrastatPorts(IntrastatPort payload, map<string|string[]> headers = {}) returns IntrastatPort|error {
        string resourcePath = string `/IntrastatPorts`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Get IntrastatPort by key
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - IntrastatPort record 
    remote isolated function getIntrastatPorts(string dataAreaId, string portId, map<string|string[]> headers = {}, *GetIntrastatPortsQueries queries) returns IntrastatPort|error {
        string resourcePath = string `/IntrastatPorts(dataAreaId='${getEncodedUri(dataAreaId)}',PortId='${getEncodedUri(portId)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Delete IntrastatPort
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatPort deleted 
    remote isolated function deleteIntrastatPorts(string dataAreaId, string portId, DeleteIntrastatPortsHeaders headers = {}) returns error? {
        string resourcePath = string `/IntrastatPorts(dataAreaId='${getEncodedUri(dataAreaId)}',PortId='${getEncodedUri(portId)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    }

    # Update IntrastatPort
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatPort updated 
    remote isolated function updateIntrastatPorts(string dataAreaId, string portId, IntrastatPort payload, UpdateIntrastatPortsHeaders headers = {}) returns IntrastatPort|error {
        string resourcePath = string `/IntrastatPorts(dataAreaId='${getEncodedUri(dataAreaId)}',PortId='${getEncodedUri(portId)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # List IntrastatSpecialMovements
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Collection of IntrastatSpecialMovement 
    remote isolated function listIntrastatSpecialMovements(map<string|string[]> headers = {}, *ListIntrastatSpecialMovementsQueries queries) returns IntrastatSpecialMovementsCollection|error {
        string resourcePath = string `/IntrastatSpecialMovements`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Create IntrastatSpecialMovement
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatSpecialMovement created 
    remote isolated function createIntrastatSpecialMovements(IntrastatSpecialMovement payload, map<string|string[]> headers = {}) returns IntrastatSpecialMovement|error {
        string resourcePath = string `/IntrastatSpecialMovements`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Get IntrastatSpecialMovement by key
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - IntrastatSpecialMovement record 
    remote isolated function getIntrastatSpecialMovements(string dataAreaId, string specialMovement, map<string|string[]> headers = {}, *GetIntrastatSpecialMovementsQueries queries) returns IntrastatSpecialMovement|error {
        string resourcePath = string `/IntrastatSpecialMovements(dataAreaId='${getEncodedUri(dataAreaId)}',SpecialMovement='${getEncodedUri(specialMovement)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Delete IntrastatSpecialMovement
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatSpecialMovement deleted 
    remote isolated function deleteIntrastatSpecialMovements(string dataAreaId, string specialMovement, DeleteIntrastatSpecialMovementsHeaders headers = {}) returns error? {
        string resourcePath = string `/IntrastatSpecialMovements(dataAreaId='${getEncodedUri(dataAreaId)}',SpecialMovement='${getEncodedUri(specialMovement)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    }

    # Update IntrastatSpecialMovement
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatSpecialMovement updated 
    remote isolated function updateIntrastatSpecialMovements(string dataAreaId, string specialMovement, IntrastatSpecialMovement payload, UpdateIntrastatSpecialMovementsHeaders headers = {}) returns IntrastatSpecialMovement|error {
        string resourcePath = string `/IntrastatSpecialMovements(dataAreaId='${getEncodedUri(dataAreaId)}',SpecialMovement='${getEncodedUri(specialMovement)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # List IntrastatTransactionCodes
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Collection of IntrastatTransactionCode 
    remote isolated function listIntrastatTransactionCodes(map<string|string[]> headers = {}, *ListIntrastatTransactionCodesQueries queries) returns IntrastatTransactionCodesCollection|error {
        string resourcePath = string `/IntrastatTransactionCodes`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Create IntrastatTransactionCode
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatTransactionCode created 
    remote isolated function createIntrastatTransactionCodes(IntrastatTransactionCode payload, map<string|string[]> headers = {}) returns IntrastatTransactionCode|error {
        string resourcePath = string `/IntrastatTransactionCodes`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Get IntrastatTransactionCode by key
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - IntrastatTransactionCode record 
    remote isolated function getIntrastatTransactionCodes(string dataAreaId, string transactionCode, map<string|string[]> headers = {}, *GetIntrastatTransactionCodesQueries queries) returns IntrastatTransactionCode|error {
        string resourcePath = string `/IntrastatTransactionCodes(dataAreaId='${getEncodedUri(dataAreaId)}',TransactionCode='${getEncodedUri(transactionCode)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Delete IntrastatTransactionCode
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatTransactionCode deleted 
    remote isolated function deleteIntrastatTransactionCodes(string dataAreaId, string transactionCode, DeleteIntrastatTransactionCodesHeaders headers = {}) returns error? {
        string resourcePath = string `/IntrastatTransactionCodes(dataAreaId='${getEncodedUri(dataAreaId)}',TransactionCode='${getEncodedUri(transactionCode)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    }

    # Update IntrastatTransactionCode
    #
    # + headers - Headers to be sent with the request 
    # + return - IntrastatTransactionCode updated 
    remote isolated function updateIntrastatTransactionCodes(string dataAreaId, string transactionCode, IntrastatTransactionCode payload, UpdateIntrastatTransactionCodesHeaders headers = {}) returns IntrastatTransactionCode|error {
        string resourcePath = string `/IntrastatTransactionCodes(dataAreaId='${getEncodedUri(dataAreaId)}',TransactionCode='${getEncodedUri(transactionCode)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # List LegalRepresentativeContacts
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Collection of LegalRepresentativeContact 
    remote isolated function listLegalRepresentativeContacts(map<string|string[]> headers = {}, *ListLegalRepresentativeContactsQueries queries) returns LegalRepresentativeContactsCollection|error {
        string resourcePath = string `/LegalRepresentativeContacts`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Create LegalRepresentativeContact
    #
    # + headers - Headers to be sent with the request 
    # + return - LegalRepresentativeContact created 
    remote isolated function createLegalRepresentativeContacts(LegalRepresentativeContact payload, map<string|string[]> headers = {}) returns LegalRepresentativeContact|error {
        string resourcePath = string `/LegalRepresentativeContacts`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Get LegalRepresentativeContact by key
    #
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - LegalRepresentativeContact record 
    remote isolated function getLegalRepresentativeContacts(string fiscalOrganizationRootFiscalEstablishmentDataArea, string fiscalOrganizationRootFiscalEstablishment, string legalRepresentativeCPF, string legalRepresentativeRole, string contactNumberOrAddress, map<string|string[]> headers = {}, *GetLegalRepresentativeContactsQueries queries) returns LegalRepresentativeContact|error {
        string resourcePath = string `/LegalRepresentativeContacts(FiscalOrganizationRootFiscalEstablishmentDataArea='${getEncodedUri(fiscalOrganizationRootFiscalEstablishmentDataArea)}',FiscalOrganizationRootFiscalEstablishment='${getEncodedUri(fiscalOrganizationRootFiscalEstablishment)}',LegalRepresentativeCPF='${getEncodedUri(legalRepresentativeCPF)}',LegalRepresentativeRole='${getEncodedUri(legalRepresentativeRole)}',ContactNumberOrAddress='${getEncodedUri(contactNumberOrAddress)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    # Delete LegalRepresentativeContact
    #
    # + headers - Headers to be sent with the request 
    # + return - LegalRepresentativeContact deleted 
    remote isolated function deleteLegalRepresentativeContacts(string fiscalOrganizationRootFiscalEstablishmentDataArea, string fiscalOrganizationRootFiscalEstablishment, string legalRepresentativeCPF, string legalRepresentativeRole, string contactNumberOrAddress, DeleteLegalRepresentativeContactsHeaders headers = {}) returns error? {
        string resourcePath = string `/LegalRepresentativeContacts(FiscalOrganizationRootFiscalEstablishmentDataArea='${getEncodedUri(fiscalOrganizationRootFiscalEstablishmentDataArea)}',FiscalOrganizationRootFiscalEstablishment='${getEncodedUri(fiscalOrganizationRootFiscalEstablishment)}',LegalRepresentativeCPF='${getEncodedUri(legalRepresentativeCPF)}',LegalRepresentativeRole='${getEncodedUri(legalRepresentativeRole)}',ContactNumberOrAddress='${getEncodedUri(contactNumberOrAddress)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    }

    # Update LegalRepresentativeContact
    #
    # + headers - Headers to be sent with the request 
    # + return - LegalRepresentativeContact updated 
    remote isolated function updateLegalRepresentativeContacts(string fiscalOrganizationRootFiscalEstablishmentDataArea, string fiscalOrganizationRootFiscalEstablishment, string legalRepresentativeCPF, string legalRepresentativeRole, string contactNumberOrAddress, LegalRepresentativeContact payload, UpdateLegalRepresentativeContactsHeaders headers = {}) returns LegalRepresentativeContact|error {
        string resourcePath = string `/LegalRepresentativeContacts(FiscalOrganizationRootFiscalEstablishmentDataArea='${getEncodedUri(fiscalOrganizationRootFiscalEstablishmentDataArea)}',FiscalOrganizationRootFiscalEstablishment='${getEncodedUri(fiscalOrganizationRootFiscalEstablishment)}',LegalRepresentativeCPF='${getEncodedUri(legalRepresentativeCPF)}',LegalRepresentativeRole='${getEncodedUri(legalRepresentativeRole)}',ContactNumberOrAddress='${getEncodedUri(contactNumberOrAddress)}')`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
