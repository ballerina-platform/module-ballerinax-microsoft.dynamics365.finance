...
isolated function applyOrderBy(json[] data, string expr) returns json[] {
    ...
    // sorted by decimal value so negative numbers and differing magnitudes
    // don't sort lexicographically (e.g. "-11500" < "-1000" < "7400" < "12500"
    // was previously coming out as "7400" > "12500" > "-7400" > "-11500" > "-1000").
