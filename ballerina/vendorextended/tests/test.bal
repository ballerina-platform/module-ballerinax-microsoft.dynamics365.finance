...
import ballerinax/microsoft.dynamics365.finance.vendorextended.mock as mockSrv;
...
@test:Config
function testListVendorsV2() returns error? {
    Client cl = check buildClient();
    VendorsV2Collection response = check cl->listVendorsV2();
